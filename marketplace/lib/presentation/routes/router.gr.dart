...
import '../../domain/entity/product.dart' as _i19;
...
class AppRouter extends _i16.RootStackRouter {
  ...
  final Map<String, _i16.PageFactory> pagesMap = {
    ...
    ProductRoute.name: (routeData) {
      ...
      return _i16.MaterialPageX<dynamic>(
          routeData: routeData,
          child: _i8.ProductPage(key: args.key, product: args.product));
    },
    LoginRoute.name: (routeData) {
      final args = routeData.argsAs<LoginRouteArgs>(
          orElse: () => const LoginRouteArgs());
      return _i16.MaterialPageX<dynamic>(
          routeData: routeData, child: _i9.LoginPage(key: args.key));
    },
    LogWithEmailRoute.name: (routeData) {
      final args = routeData.argsAs<LogWithEmailRouteArgs>(
          orElse: () => const LogWithEmailRouteArgs());
      return _i16.MaterialPageX<dynamic>(
          routeData: routeData, child: _i10.LogWithEmailPage(key: args.key));
    },
    DiscoverRoute.name: (routeData) {
      return _i16.MaterialPageX<dynamic>(
          routeData: routeData, child: const _i11.DiscoverPage());
    },
    ...
    FilterRoute.name: (routeData) {
      ...
      return _i16.MaterialPageX<dynamic>(
          routeData: routeData,
          child: _i15.FilterPage(key: args.key, filter: args.filter));
    }
  };
  ...
  List<_i16.RouteConfig> get routes => [
        ...
        _i16.RouteConfig(WelcomeRoute.name, path: '/welcome'),
        _i16.RouteConfig(LoginEmpty.name, path: '/login', children: [
          _i16.RouteConfig(LoginRoute.name, path: '', parent: LoginEmpty.name),
          _i16.RouteConfig(LogWithEmailRoute.name,
        ...
        _i16.RouteConfig(HomeRoute.name, path: '/home', children: [
          _i16.RouteConfig('#redirect',
              ...
              redirectTo: 'discover',
              fullMatch: true),
          _i16.RouteConfig(DiscoverRoute.name,
              path: 'discover', parent: HomeRoute.name),
          _i16.RouteConfig(SearchEmpty.name,
              path: 'search',
              parent: HomeRoute.name,
              children: [
                _i16.RouteConfig(SearchRoute.name,
                    path: '', parent: SearchEmpty.name),
                _i16.RouteConfig(FilterRoute.name,
                    path: 'filter', parent: SearchEmpty.name)
              ]),
          _i16.RouteConfig(DesiredRoute.name,
              path: 'desired', parent: HomeRoute.name),
          _i16.RouteConfig(MenuRoute.name, path: 'menu', parent: HomeRoute.name)
        ]),
        _i16.RouteConfig(CartRoute.name, path: '/cart'),
        _i16.RouteConfig(NotificationRoute.name, path: '/notification'),
        _i16.RouteConfig(ProfileRoute.name, path: '/profile'),
        _i16.RouteConfig(ProductRoute.name, path: '/product')
      ];
}
...
class HomeRoute extends _i16.PageRouteInfo<HomeRouteArgs> {
  HomeRoute({_i18.Key? key, List<_i16.PageRouteInfo>? children})
...
class ProductRoute extends _i16.PageRouteInfo<ProductRouteArgs> {
  ProductRoute({_i18.Key? key, required _i19.Product product})
...
class LogWithEmailRoute extends _i16.PageRouteInfo<LogWithEmailRouteArgs> {
  LogWithEmailRoute({_i18.Key? key})
...
class FilterRoute extends _i16.PageRouteInfo<FilterRouteArgs> {
  FilterRoute({_i18.Key? key, required _i20.Filter filter})
