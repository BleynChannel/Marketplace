...
class _$_Profile extends _Profile {
  ...
  @override
  String toString() {
    return 'Profile(nickname: $nickname, avatar: $avatar, backgroundImage: $backgroundImage, status: $status, purchases: $purchases, desired: $desired, contacts: $contacts, achievements: $achievements, favoriteGames: $favoriteGames, registrationDate: $registrationDate, lastActivity: $lastActivity)';
  }
