...
class _$_User implements _User {
  const _$_User({required this.nickname, required this.avatar});
  ...
  @override
  String toString() {
    return 'User(nickname: $nickname, avatar: $avatar)';
  }
...
abstract class _User implements User {
  const factory _User(
      {required final String nickname, required final Media avatar}) = _$_User;
